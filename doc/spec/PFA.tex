...
or
\begin{json}
{"foreach": NAME, "in": ARRAY-EXPRESSION, "do": EXPRESSION-OR-EXPRESSIONS, "seq": TRUE-OR-FALSE}
\end{json}
...
\begin{json}
{"forkey": NAME1, "forval": NAME2, "in": MAP-EXPRESSION, "do": EXPRESSION-OR-EXPRESSIONS}
\end{json}
