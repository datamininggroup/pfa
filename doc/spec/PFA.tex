...
Special forms are similar to function calls in that they take arguments, perform a function, and return a value, but special forms may have more than one JSON object member.
