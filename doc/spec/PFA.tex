...
Special forms are similar to function calls in that they take arguments, perform an operation, and return a value, but special forms can have more than one JSON object member and can apply custom interpretations to their arguments.  A function always has the same form: one member name and an expression or array of expressions.
